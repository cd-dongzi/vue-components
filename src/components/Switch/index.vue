<template>
    <div class="switch-wrapper">
        <label><input class="mui-switch" :class="animate === 1 ? 'mui-switch-anim': animate === 2 ? 'mui-switch-animbg':''" type="checkbox" ref="obj" @click="toggle"></label>
    </div>
</template>
<script>
    export default {
...
.mui-switch {
  ...
  &:before {
    ...
    box-shadow: 0 0.01px 3px rgba(0, 0, 0, 0.4);
  }
  &:checked {
